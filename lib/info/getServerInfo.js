...
async function getServerInfo(guild) {
  ...
  return {
    ...
    fields: [
      ...
      { name: `${getServerEmoji('CHANNEL')} チャンネル`, value: `${channelCount}個` },
      { name: `${getServerEmoji('EMOJI')} 絵文字`, value: `${emojiCount}個`, inline: true },
      { name: `${getServerEmoji('BAN')} BAN`, value: `${banCount}人`, inline: true },
      { 
