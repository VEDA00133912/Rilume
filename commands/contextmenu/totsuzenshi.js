const { ContextMenuCommandBuilder, ApplicationCommandType, ApplicationIntegrationType, MessageFlags } = require('discord.js');
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (text.length < 1 || text.length > 100) {
            return interaction.editReply({ content: 'テキストの長さは1文字以上、100文字以下にしてください' });
        };
